...
CREATE TABLE CLIENTES (
    ...
    appellido_pat  TEXT NOT NULL,
    appellido_mat  TEXT NOT NULL,
    direccion      TEXT,
    telefono       TEXT,
    correo         TEXT,
...
CREATE INDEX idx_transacciones_cuenta_fecha ON TRANSACCIONES(id_cuenta, fecha_hora DESC);

INSERT INTO CLIENTES(id_cliente, dni, nombres, apellido_pat, apellido_mat, direccion)
VALUES ('CL001','45678912','MARÍA ELENA','GARCÍA','FLORES','Av. Universitaria 1234');
VALUES ('CL001','12345678','JUAN CARLOS','RAMÍREZ', 'QUISPE','Av. La Molina 5678');
